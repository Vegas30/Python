...
# print(s_result)
#
# # 13. Напиши фуекцию, которая принимает список строк и объединяет их в одну
...
# # Получить шесть чисел, образованных при перестановке цифр
# # заданного числа.
#
...
# print(str3)
#
# # 25. Сравнить две строки по уникальным символам.
# str1 = 'apple'
# str2 = 'banana'
...
# s = 'Hello world'
# s_mirror = ' '.join(word[::-1] for word in s.split())
# print(s_mirror)

# 27.

# 28. Удалить дубликаты с сохранением порядка
...
# 31. Создайте аббреавиатуру
s = 'Hello world this is Python'
s_2 = s.title()
s_res = ' '.join(i[0] for i in s_2.split())
s_res2 = ' '.join(i[0].upper() for i in s_2.split())
...
result = s.isalnum()
if result:
    print("в строке есть и цифры и буквы")
else:
    print("")