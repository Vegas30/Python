...
SELECT l.*
FROM test.lessons AS l
JOIN test.teachers AS t ON l.teacher_id = t.idTeachers
WHERE t.surname = 'Петров';
...
-- 40. Выбрать имена всех преподавателей, проводивших уроки с аудиторией больше 3: 
